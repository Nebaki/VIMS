...
class CheckPhoneForm extends StatefulWidget {
  const CheckPhoneForm({super.key});

  @override
  State<CheckPhoneForm> createState() => _CheckPhoneFormState();
}

class _CheckPhoneFormState extends State<CheckPhoneForm> {
              ...
              child: TextButton(
                ...
                onPressed: () {
                  if (formKey.currentState!.validate()) {
                    ...
                    // print(CheckUserController.phoneController.text);
